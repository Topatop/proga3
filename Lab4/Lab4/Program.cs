...
using TodoList = Lab4.services.TodoList;
...
internal static class Program
{
    private static void Main()
    {
        ...
        var jsonFilePath = "C:\\Users\\savva\\OneDrive\\Рабочий стол\\учёба\\новый шарп\\proga3\\Lab4\\Lab4\\storage\\Data.json";
        var xmlFilePath = "C:\\Users\\savva\\OneDrive\\Рабочий стол\\учёба\\новый шарп\\proga3\\Lab4\\Lab4\\storage\\Data.xml";
        var sqliteFilePath = "C:\\Users\\savva\\OneDrive\\Рабочий стол\\учёба\\новый шарп\\proga3\\Lab4\\Lab4\\storage\\Data.sqlite";
        ...
        new RestApiThread(restApiConfig).Start();
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case "4":
                    ...
                    {
                        case "1":
                            todoList.Save(jsonFilePath, SaveMode.JSON);
                            break;
                        case "2":
                            todoList.Save(xmlFilePath, SaveMode.XML);
                            break;
                        case "3":
                            todoList.Save(sqliteFilePath, SaveMode.SQLite);
                            break;
                        case "4":
                            break;
                        default:
                ...
                case "5":
                    ...
                    {
                        case "1":
                            todoList.Load(jsonFilePath, SaveMode.JSON);
                            break;
                        case "2":
                            todoList.Load(xmlFilePath, SaveMode.XML);
                            break;
                        case "3":
                            todoList.Load(sqliteFilePath, SaveMode.SQLite);
                            break;
                        case "4":
                            break;
                        default:
